...
json_dir = "//usr/local/scratch/parisa/data/test_detectron/" #single_box_annotation_val.json
data_dir = "/projects/progstar/all_oct_imgs_progstar02_quality_checked/adequate/"

for d in ["train", "val"]:
    DatasetCatalog.register("oct_" + d, lambda d=d: get_oct_dicts(json_dir + "single_box_annotation_" + d + ".json", data_dir))
...
cfg.OUTPUT_DIR = 'output_lossevalhook'
...
evaluator = COCOEvaluator("oct_val", output_dir=cfg.OUTPUT_DIR)
